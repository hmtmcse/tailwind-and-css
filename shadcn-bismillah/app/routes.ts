...
export default [
    ...
    route("/testing/calendar", "component-test/calendar-test.tsx"),
    route("/testing/accordion", "component-test/accordion-test.tsx"),
    ...
    route("/panel/login-04", "app-frame/login-04/page.tsx"),
